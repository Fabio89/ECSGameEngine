...
export module Serialization.Json;
import Core;
import Math;
...
export namespace Json
{
    ...
    JsonDocument fromFile(const std::filesystem::path& path);
    void toFile(const JsonDocument& document, const std::filesystem::path& path);
